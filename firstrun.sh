...
sudo pacman -Sq sshfs dkms htop sc man python-pywal ranger firefox qutebrowser xclip vim iw iwd git texlive-most xf86-video-intel xorg-server xorg-xinit noto-fonts cmus acpi fzf libxinerama libx11 alsa-utils xorg-xsetroot git zathura zathura-pdf-mupdf keepass feh picom mpv alsa-utils pulseaudio ueberzug
